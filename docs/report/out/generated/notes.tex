...
\begin{caveat}{MVC-10 \; --- \; MVC. Minimum viable capital}
\textbf{Claim under test.} Tax drag was absent from the first draft of this section and raises the capital floor materially

\textbf{Method.} MVC at F=\$360/yr, SR=0.5, across blended short-term rates

\textbf{Expected.} untaxed \$5,790 \quad \textbf{Measured.} 15\%: \$6,812 (+18\%); 24\%: \$7,619 (+32\%); 30\%: \$8,272 (+43\%); 37\%: \$9,191 (+59\%)

At the \textasciitilde{}200\% annual turnover of a vol-managed sleeve essentially all gains are SHORT-TERM, taxed as ordinary income. Worse, for an individual without trader status the data subscription is not deductible at all -- the Tax Cuts and Jobs Act suspended miscellaneous itemized deductions -- so the fixed cost is paid with after-tax dollars while the profit is taxed. At a 30\% blended rate the floor rises from \$5,790 to \$8,272, a 43\% increase, and the effect compounds with the hyperbolic sensitivity to Sharpe in MVC-04. \textbf{The practical consequence is a recommendation the report did not previously make: hold this strategy in a Roth IRA.} A high-turnover, long-only, unlevered strategy is close to the ideal case for a tax-sheltered wrapper, where $t=0$ and the entire drag disappears. The constraints -- annual contribution limits and restricted withdrawals -- are nearly irrelevant at this account size and for capital that is not needed back. Nothing here is tax advice; confirm treatment with a qualified professional.
\end{caveat}
